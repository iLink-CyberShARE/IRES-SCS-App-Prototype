 ...
 * <h1> Http Handler </h1>
 *
 * Connection to the ports use for the reports and map servers
 *
 *
...
public class HTTPHandler {
    private String reportsUrl = "http://localhost:3000";
    private String mapUrl = "http://localhost:4000";
    ...
    public static String sendPut(String url) throws IOException {
        URL obj = new URL(url);
        Log.d("UTEPCS", url);
